angular.module('vtms').factory('vtmsTask', function($resource, $q, $rootScope, vtmsNotifier) {
  var TaskResource = $resource('/api/tasks/:id', {id: '@id'}, {
    ...
    getLastTaskForLesson: {method: 'GET', url:'/api/lessons/:id/tasks/last-completed', isArray: false},
    getActionableTasksForMember: {method: 'GET', url:'/api/team-members/:id/tasks/actionable', isArray:true},
    getActiveTaskForMember: {method: 'GET', url:'/api/team-members/:id/tasks/active', isArray:false},
