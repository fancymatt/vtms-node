            ...
            lessons.forEach(function(lesson) {
              ...
              var lessonCompletionValue = 0;
                ...
                Task.findAll({where: {fkLesson: lesson.id}, include: [TaskGlobal]}).then(function(tasks) {
                  ...
                  console.log("Series completion value: " + totalCompletionValue + "\nLesson completion value: " + lessonCompletionValue);
                  if(lessonCompletionValue >= totalCompletionValue) {
                    lesson.allTasksCompleted = true;
                  } else {
                    lesson.allTasksCompleted = false;
                  }
