...
module.exports = function(app) {
  ...
  app.get('/api/users', controllers.user.getUsers);
  ...
  app.get('/api/lessons/:id/issues/last-completed', controllers.issue.getLastIssueForLessonWithId);
  app.get('/api/lessons/:id/tasks', controllers.task.getTasksForLessonWithId);
  app.get('/api/lessons/:id/tasks/last-completed', controllers.task.getLastTaskForLessonWithId);
  ...
  app.get('/api/publish-dates/ready', controllers.publishDate.getReadyToDeliverPublishDates);
